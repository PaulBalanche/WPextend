	...
	*/
	 ...
	 */
	 public static function render_export() {
		...
		// Custom post type
		$retour_html .= Wpextend_Render_Admin_Html::table_edit_open();
		$retour_html .= Wpextend_Type_Field::render_input_textarea( 'WP Extend Custom Post Type', 'wpextend_custom_post_type_export', stripslashes( json_encode( Wpextend_Post_Type::getInstance()->custom_post_type_wpextend, JSON_UNESCAPED_UNICODE ) ) );
		$retour_html .= Wpextend_Render_Admin_Html::table_edit_close();
